...
import { moderateScale } from '../utility/responsive';

export type JobFilterChip = 'accepted' | 'rejected';

const CHIPS: {id: JobFilterChip; label: string}[] = [
  {id: 'accepted', label: 'Accepts order'},
  {id: 'rejected', label: 'Reject order list'},
];
